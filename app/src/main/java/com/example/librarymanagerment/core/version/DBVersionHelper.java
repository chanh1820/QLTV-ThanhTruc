...
public class DBVersionHelper extends SQLiteOpenHelper {

    private static final String DB_PATH = "/data/data/com.example.librarymanagerment/databases/";
    private static final String DB_NAME = "version.sqlite";
