...
public class SPNChooseStudentAdapter extends BaseAdapter {
    Context context;
    List<StudentDTO> items;

    public SPNChooseStudentAdapter(Context context, List<StudentDTO> items) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        tvContent.setText(items.get(i).getStudentName());
