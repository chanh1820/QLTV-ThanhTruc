...
public class DatTruocActivity extends AppCompatActivity {

    Button btnBack;
    RecyclerView rvOrder;
    ProgressBar progressBar;
    ListDatTruocAdapter listDatTruocAdapter;
    ...
    private void loadListOrder() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, GoogleSheetConstants.END_POINT_URL, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                listDatTruocAdapter = new ListDatTruocAdapter(DatTruocActivity.this, orderDTOList, new DatTruocClickListener() {
                    @Override
                    ...
                    public void onButtonPickClick(OrderDTO item) {
                        Intent intent = new Intent(DatTruocActivity.this, AddTransactionActivity.class);
                ...
                LinearLayoutManager llm = new LinearLayoutManager(DatTruocActivity.this);
                llm.setOrientation(LinearLayoutManager.VERTICAL);
                rvOrder.setLayoutManager(llm);
                rvOrder.setAdapter(listDatTruocAdapter);
            }
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                orderSCO.setStatus(DBConstants.STATUS_ORDER_WAITING_APPROVE);
                orderSCO.setUserName("");
